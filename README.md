...
### Code Institute: Interactive Front End Development Milestone Project
...
- [DC CSS](https://cdnjs.com/libraries/dc)
    - The project uses **DC.css** as per convention.
...
- CSS Flexbox could of been utilized more efficiently, there is an over reliance on media queries when positioning elements across various screen sizes.

- The positioning of the elements is not perfect across all screen sizes. The website will look better on some screens, depending on the smartphone being used.
